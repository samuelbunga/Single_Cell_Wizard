...
<head>
  ...
  <h1 style="margin-left: 120px;font-size: 18px;padding-top: 20px;"> Single Cell Wizard </h1>
  <body>
    <?php
	  session_start();
 ...
 <fieldset class="field_set">
  ...
  $_SESSION['cmd2'] = "sudo ./web_pipeline_bash_script.sh " . $_SESSION['dir2'] . " " . $_SESSION['gmt'] . " " . $gmtDir;
	echo $_ENV["USER"];
  exec($_SESSION['cmd']);
  exec($_SESSION['cmd2']);
...
<br />
<img class="logo" src= "<?php $_SESSION['tsne2']= './out/' .  $_SESSION['job_name2'] . '/' . $_SESSION['job_name2'] . '_tsne'; echo $_SESSION['tsne2'];?>" alt=<?php echo $_SESSION['tsne'];?>/>
