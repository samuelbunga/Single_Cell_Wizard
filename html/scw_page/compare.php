...
<!--<head>
 ...
 <fieldset class="field_set">
	...
	chdir("/home/ubuntu/ksharma");
  $_SESSION['cmd'] = "sudo ./web_pipeline_bash_script.sh " . $_SESSION['dir'] . " " . $_SESSION['dir2'] . " " . $_SESSION['gmt'] . " " . $gmtDir . " " . $_SESSION['out'];
...
<img class="logo" src= "<?php $_SESSION['tsne']= './out/' .  $_SESSION['job_name'] . '/' . 'combined.object_plot.png'; echo $_SESSION['tsne'];?>" alt=<?php echo $_SESSION['tsne'];?>/>
</div>
<div style="display:inline-block;">
...
foreach($files as $file){?>
    <tr>
        <td>
    <?php
       if(strcmp("combined.object_plot.png", $file) == 0){
        echo "Combined Plot: ";}
       ...
       elseif(strcmp("Conserved_Markers.xlsx", $file) == 0){
	echo "Markers conserved across samples: ";}
